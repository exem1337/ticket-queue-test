<template>
    <nav class="shadow">
        <ul class="big-screen">
            <li @click="store.commit('SWITCH_PAGE', 1)" :class="{ active: store.state.currentPage === 1 }">Очередь</li>
            <li @click="store.commit('SWITCH_PAGE', 2)" :class="{ active: store.state.currentPage === 2 }">Запись</li>
            <li @click="store.commit('SWITCH_PAGE', 3)" :class="{ active: store.state.currentPage === 3 }">Админ</li>
        </ul>
...
.small-screen{
    ...
    animation: toggleBurger .3s ease-in-out;
