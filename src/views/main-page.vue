<template>
  <div class="container">
    ...
    <p v-if="!store.state.queueMembers.length" style="margin-top: 100px;">Очередь пуста... Какая редкость в нашей жизни</p>
    <div class="bottom-inner">
      <div v-if="store.state.queueMembers.length > 10" class="more">и еще {{store.state.queueMembers.length-10}} человек...</div>
